	...
	<div class="row container-fluid px-3 px-sm-5 my-5 text-center">
		...
		<div class="col-md-4 mb-4">
			<section>
				<div class="card">
                    <div class="card-header text-center py-1">
                        <h5 class="mb-0 fw-bold">Gói 1</h5>
                    </div>		
                    <div class="card-body">
                        <h3 class="text-warning mb-2">299.000/tháng</h3>
						<h6>Mỗi hộp bao gồm: </h6>
                        <ol class="list-group list-group-numbered">
							<li class="list-group-item">Áo premeum T-shirt</li>
							<li class="list-group-item">Quần lót bamboo</li>
							<li class="list-group-item">Tất (vớ)</li>
						</ol>
                        <p>Chọn kích cỡ</p>
                        <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                            <input type="radio" class="btn-check" name="btnGroupRadio" id="btnRadio1" autocomplete="off" checked="">
                    ...
                    <div class="card-footer d-flex justify-content-between py-3">
                        <select class="form-select-sm" aria-label="Small select">
							<option selected="">Chọn chu kì gửi</option>
							<option value="1">Gửi mỗi 15 ngày</option>
							<option value="2">Gửi mỗi 30 ngày</option>
							<option value="3">Gửi mỗi 45 ngày</option>
						</select>
